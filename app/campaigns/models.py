...
class Question(models.Model):
    ...
    answer_choices = models.CharField(max_length=1000, null=False, blank=True, help_text="Example choice format for a radio or check answer template ['Red','Blue','Green']")
